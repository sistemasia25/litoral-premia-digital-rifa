...
const Header = () => {
  ...
  return <header className="bg-black border-b border-gray-800 px-4 py-3">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link to="/" className="flex items-center space-x-2">
          <img src="/lovable-uploads/56e53f5a-394f-4d5c-add8-3c27c7e9ebc7.png" alt="Litoral Premia" className="w-12 h-12" />
        </Link>
