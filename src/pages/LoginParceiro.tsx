...
const LoginParceiroPage = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50">
      ...
      <div className="absolute top-4 left-4 z-10">
        <Button variant="ghost" onClick={() => navigate('/')} className="text-gray-600 hover:text-gray-800 hover:bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="space-y-6">
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="space-y-2">
                      ...
                      <Input id="email" name="email" type="email" value={formData.email} onChange={handleInputChange} placeholder="seu@email.com" className="h-12 border-gray-200 focus:border-orange-500 focus:ring-orange-500" required />
                    </div>
                    
                    <div className="space-y-2">
                      <Label htmlFor="password" className="text-gray-700 font-medium">Senha</Label>
                      <div className="relative">
                        <Input id="password" name="password" type={showPassword ? "text" : "password"} value={formData.password} onChange={handleInputChange} placeholder="Sua senha" className="h-12 border-gray-200 focus:border-orange-500 focus:ring-orange-500 pr-12" required />
                    ...
                    <Button type="submit" className="w-full h-12 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold shadow-lg" disabled={isLoading}>
                      {isLoading ? <>
                          <motion.div animate={{
                        rotate: 360
                      }} transition={{
                  ...
                  <div className="text-center space-y-4">
                    <Button variant="link" className="text-orange-600 hover:text-orange-700 font-medium">
                      Esqueci minha senha
                    </Button>
                    ...
                    <Button variant="outline" onClick={() => navigate('/cadastro-parceiro')} className="w-full h-12 border-orange-200 text-orange-600 hover:bg-orange-50 hover:border-orange-300 font-semibold">
                  ...
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4 mb-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-center">
                        <div>
                          <p className="text-2xl font-bold text-teal-400">R$1000 em vendas</p>
                          <p className="text-orange-100 text-sm">por mês</p>
                        </div>
                        <div>
                          <p className="text-2xl font-bold text-teal-400">R$ 300</p>
                    ...
                    <div className="flex items-center justify-center space-x-2 text-orange-100">
                      ...
                      <span className="text-sm">Pagamento semanal via pix</span>
                    </div>
                  </CardContent>
                </Card>
              </motion.div>
